...
import {ParamBoolean, ParamList, ParamSelect, ParamString} from "Shared/Inspector/index";
        ...
        try {
            switch (param.type) {
                ...
                case Constants.param.type.list    :
                    paramElement =
                        <ParamList label={label} param={param} disabled={disabled} value={value} onChange={onChange}
                                   headers={headers} />;
                    break;
            }
        } catch (e) {
