        ...
        .then((result: any) => {
          if (result.success === true) {
            ...
            if(selected_step.uuid){
              ...
              window.open('/preview?step_id='+ id + '&dialog=true&step_ids=' + StringUtil.urlEncode(JSON.stringify(stepIds)) + '&flow_uuid=' + flow_uuid + '&title=' + StringUtil.base64encode(selected_step.label)) ;
            }
          }
        })
        .catch((message) => {
