...
export default class ModalManager extends React.Component<Props> {
       ...
       render() {
              ...
              return <>
                     ...
                     <Modal key={Constants.modal.IMPORT_PROJECT} id={Constants.modal.IMPORT_PROJECT}
                            title="プロジェクトのインポート" dynamic={true} done={"作成する"} primary={true}>
                     </Modal>
                     ...
                     <Modal key={Constants.modal.CONFIRM_UPDATE_KSKP_SYSTEM_ADMIN} id={Constants.modal.CONFIRM_UPDATE_KSKP_SYSTEM_ADMIN}
                            title="KSKP 管理権限の設定" dynamic={true} footer={true}>
                     </Modal>
