...
export default class Modal extends React.Component<Props, State> {
    ...
    render() {
        ...
        const backdrop = (visible) ? <div onClick={() => this.onClickBackdrop()}
                                          className={"modal-backdrop fade show" + ((preview) ? " preview" : "")}/> :
        ...
        if (preview) {
            modal = <PreviewModal id={id} title={title} footer={modal_footer} close_button={close_button} visible={visible}>
                {modal_body}
            </PreviewModal>
        } else {
            modal = <StandardModal id={id} title={title} footer={modal_footer} close_button={close_button} visible={visible}>
                {modal_body}
            </StandardModal>
        }
