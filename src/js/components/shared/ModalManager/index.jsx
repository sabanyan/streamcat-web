  ...
  render () {
    ...
    return <div>
      ...
      <Modal key={Constants.modal.ADD_FRAME} id={Constants.modal.ADD_FRAME}
             title="フレームをアップロードする" dynamic={true} done={'追加する'} primary={true}>
      </Modal>
      ...
      <Modal key={Constants.modal.SHOW_FLOW_SETTING} id={Constants.modal.SHOW_FLOW_SETTING}
             title="選択されたフローを実行します" dynamic={true} done={'作成する'} cancel={'キャンセル'}>
      </Modal>
    </div>
  }
}
